        ...
        <div className="no-drag pl-3 flex items-center gap-1">
          ...
          <div className="flex items-center gap-px">
            <button
              ...
              className="cursor-pointer w-10 h-10 flex items-center justify-center hover:bg-zinc-700 transition-colors"
              style={{ color: '#71717a' }}
              title="Minimize"
            >
            ...
            <button
              type="button"
              onClick={() => window.sifeEngine.windowMaximize()}
              className="cursor-pointer w-10 h-10 flex items-center justify-center hover:bg-zinc-700 transition-colors"
              style={{ color: '#71717a' }}
              title="Maximize"
            >
            ...
            <button
              type="button"
              onClick={() => window.sifeEngine.windowClose()}
              className="cursor-pointer w-10 h-10 flex items-center justify-center hover:bg-red-600 transition-colors"
              style={{ color: '#71717a' }}
              title="Close"
            >
